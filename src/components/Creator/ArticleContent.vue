<template>
  <div>
    <fieldset
      ...
      :key="'paragraph-'+ index"
    >
      <legend class="mx-2 font-bold rounded-lg bg-blue-900 text-white p-2">Paragraph {{index + 1}}</legend>
      <div class="absolute right-0 rounded-full w-10 -mr-3 -mt-10" @click="removeParagraph(index)">
...
export default {
  ...
  methods: {
    ...
    addParagraph() {
      this.paragraphs.push({ content: "", images: [] });
    },
  },
};
</script>
