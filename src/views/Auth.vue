        ...
        <div class="relative flex flex-wrap">
          <div class="w-full relative">
            <div class="mt-6">
              ...
              <div class="text-sm text-center font-semibold">Lorem ipsum dolor, sit amet?</div>

              <form class="mt-8" action="user.html">
                <div class="mx-auto max-w-lg">
                  ...
                  <div class="flex flex-col flex-wrap content-center text-center">
                    ...
                    <div class="text-sm font-semibold block sm:hidden py-3">
          ...
          <div class="w-full relative">
            ...
            <div class="md:mt-6">
              ...
              <div class="text-sm font-semibold block sm:hidden py-6 flex justify-center">
                <a href="#" class="font-normal border-b-2 border-gray-200 hover:border-teal-500">
