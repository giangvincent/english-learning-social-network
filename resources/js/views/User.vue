<template>
    <div>
        ...
        <div class="flex">
            ...
            <div
                class="w-full px-4 mt-10 md:mt-6 md:px-6 lg:px-8 md:w-4/5 pt-16"
            >
                <div class="sm:rounded sm:rounded-t-lg shadow bg-white">
                    ...
                    <div class="text-center px-3 pb-6 pt-2">
                        <h3 class="font-bold text-2xl inline">
                            {{ user.full_name }}
                        </h3>
        ...
        <user-created
            v-if="typeof $route.query.cur === 'undefined'"
        ></user-created>
