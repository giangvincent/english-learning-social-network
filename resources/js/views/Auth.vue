            ...
            <div class="mt-8 w-full mx-auto">
                ...
                <div class="flex justify-between">
                    <label class="block text-gray-500 font-bold my-4">
                        ...
                        />
                        <span
                            class="pl-2 py-2 text-sm text-gray-600 leading-snug"
                ...
                <div class="flex flex-col flex-wrap content-center text-center">
                    ...
                    <div class="text-sm font-semibold block py-3">
                        <a
                            @click="changeAuthRoute('register')"
                            class="font-normal"
                        >
        ...
        >
            ...
            <div class="mt-8 mx-auto w-full">
                ...
                <div class="flex justify-start">
                    <label
                        class="block text-gray-500 font-bold my-4 flex items-center"
                    >
                        <input
                ...
                <div
                    class="text-sm font-semibold block py-6 flex justify-center"
                >
                    <a
