...
<head>
    ...
    <title>Thatsgood Policies & Service terms</title>

    <!-- Primary Meta Tags -->
    <meta name="title" content="Thatsgood Policies & Service terms">
    <meta name="description" content="Thatsgood Policies & Service terms">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://backend.thatsgood.info/policies-and-service-terms">
    <meta property="og:title" content="Thatsgood Policies & Service terms">
    <meta property="og:description" content="Thatsgood Policies & Service terms">
    <meta property="og:image" content="https://thatsgood.info/assets/images/logo.jpg">
    <meta property="fb:app_id" content="865567664256189">

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="https://backend.thatsgood.info/policies-and-service-terms">
    <meta property="twitter:title" content="Thatsgood Policies & Service terms">
    <meta property="twitter:description" content="Thatsgood Policies & Service terms">
    <meta property="twitter:image" content="https://thatsgood.info/assets/images/logo.jpg">
...
<body>
    ...
    <p>Welcome to Thatsgood!</p>

    <p>These terms and conditions outline the rules and regulations for the use of GV Edu's Website, located at
        https://thatsgood.info.</p>

    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Thatsgood if
    ...
    <p>We employ the use of cookies. By accessing Thatsgood, you agreed to use cookies in agreement with the GV Edu's
        Privacy Policy. </p>
    ...
    <p>Unless otherwise stated, GV Edu and/or its licensors own the intellectual property rights for all material on
        Thatsgood. All intellectual property rights are reserved. You may access this from Thatsgood for your own
        personal use subjected to restrictions set in these terms and conditions.</p>

    <p>You must not:</p>
    <ul>
        <li>Republish material from Thatsgood</li>
        <li>Sell, rent or sub-license material from Thatsgood</li>
        <li>Reproduce, duplicate or copy material from Thatsgood</li>
        <li>Redistribute content from Thatsgood</li>
    </ul>
    ...
    <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
        areas of the website. GV Edu does not filter, edit, publish or review Comments prior to their presence on the
        website. Comments do not reflect the views and opinions of GV Edu,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions. To the extent permitted by applicable
        laws, GV Edu shall not be liable for the Comments or for any liability, damages or expenses caused and/or
        suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.</p>

    <p>GV Edu reserves the right to monitor all Comments and to remove any Comments which can be considered
    ...
    <p>You hereby grant GV Edu a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce
    ...
    <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
        ...
        records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of GV Edu;
    ...
    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you
        must inform us by sending an e-mail to GV Edu. Please include your name, your organization name, contact
    ...
    <p>No use of GV Edu's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
